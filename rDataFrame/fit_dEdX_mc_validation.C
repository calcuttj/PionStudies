...
int fit_dEdX_mc_validation(const string file_path) {
   ...
   TH1D *fit_dEdX_std = new TH1D("fit_mc_dEdX_std", "", h2_mc_dEdX_wire->GetNbinsX(), 1, h2_mc_dEdX_wire->GetNbinsX() );
   ...
   landau_fit( minEntries, h2_mc_dEdX_wire, fit_dEdX_mpv, fit_dEdX_std, fit_dEdX_chi2, fit_dEdX_ndf );
   landau_fit( minEntries, h2_mc_SCEcorr_dEdX_wire, fit_dEdX_SCEcorr_mpv, fit_dEdX_SCEcorr_std, fit_dEdX_SCEcorr_chi2, fit_dEdX_SCEcorr_ndf );
