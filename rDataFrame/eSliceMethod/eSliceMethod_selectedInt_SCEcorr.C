...
int eSliceMethod_selectedInt_SCEcorr(const string mcFilepath, bool isMC){
   ...
   //output file
   string outputNameData = "output_eSliceMethod_selectedEvents_DATA_SCEcorr.root";
   string outputNameMC = "output_eSliceMethod_selectedEvents_MC_SCEcorr.root";
   string outputName;
   ...
   TFile f2("eSliceMethod_effPur_binByBin_SCEcorr.root");
   ...
   h_selected_totInel_interactingRecoE->Multiply( h_pur_interacting_totInel ); h_selected_totInel_interactingRecoE->Divide( h_eff_interacting_totInel );
