...
int compare_incInt_dataMC(){
   ...
   //output file
   TFile *output = new TFile ("compare_incInt_dataMC.root", "RECREATE");

   //access Jakes GeantFile in folder
   TFile f1("output_eSliceMethod_selectedEvents_MC_effPur_trueE.root");
   ...
   TFile f2("output_eSliceMethod_selectedEvents_DATA_effPur_trueE.root");
